        ...
        google.maps.event.addListener(marker, 'click', (function(marker, markerCount) {
            return function() {
                if(material === "Glass") {
                    switch(i) {
                        case 0:
                            infowindow.setContent('<font color="black">' + 
                            "<br /><center><h1>I.U.T de Bordeaux 1</h1><br />" +
                            "<p align=\"middle\"><b>JAUME Benjamin <br/>" +
                            "AUBOIN Charly <br />" +
                            "BOEZ Mathieu <br />" +
                            "CONGARD Ronan </b></p><br />" +
                            "<p>Address : <b>" + addressGlassFR[i] + "</b></p><br />" +
                            '<img src="images/bordeauxSchool.jpg" width="90%" height="80" /></center><br />' +
                            '</font>');
                            infowindow.open(map, marker);
                            break;
                        default:
                            infowindow.setContent("<font color=\"black\">" + 
                                "<br /><center><h1>" + material + " container n°" + i + "</h1></center><br />" +
                                "<table><tr>" + 
                                "<td>" +
                    ...
                    if(material === "Clothes") {
                        infowindow.setContent("<font color=\"black\">" + 
                                "<br /><center><h1>" + material + " container n°" + (i+1) + "</h1></center><br />" +
                                "<table>" +
                                    '<tr width="100%">' +
                                        "<td>" +
        ...
        google.maps.event.addListener(marker, 'click', (function(marker, markerCount) {
            return function() {
                ...
                switch(i) {
                    case 0:
                        infowindow.setContent("<font color=\"black\">" + 
                            "<br /><center><h1>Jade Hochschule</h1><br />" +
                    ...
                    default:
                        infowindow.setContent("<font color=\"black\">" + 
                                "<br /><center><h1>Container n°" + i + "</h1></center><br />" +
                                "<table><tr>" + 
                                "<td>" +
